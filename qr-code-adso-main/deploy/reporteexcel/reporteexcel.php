...
if (mysqli_connect_errno()) {
   ...
   exit();
	...
	if($resultado->num_rows > 0 ){
		...
		$titulosColumnas = array('Documento', 'Nombres', 'Apellido', 'sn_Mostra','SN_contar','Fecha de regitro','Rol','Codigo de documento','Codigo de genero','Codigo programa','Hombre','Mujeres', 'Mayor', 'Menor');
		...
		$objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('K6',  $titulosColumnas[12])
                    ->setCellValue('L6',  $titulosColumnas[13]);
          		
		
		//Se agregan los datos de los alumnos
        $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('K'.'4',  conteo_genero('cod_genero','14'))
                ->setCellValue('L'.'4',  conteo_genero('cod_genero','15'))
                ->setCellValue('K'.'7',  conteo_genero('cod_tipo_doc','1'))
                ->setCellValue('L'.'7',  conteo_genero('cod_tipo_doc','2'));
		$i = 4;
